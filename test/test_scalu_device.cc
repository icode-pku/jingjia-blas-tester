...
void test_scalu_device_work( Params& params, bool run )
{
...
// -----------------------------------------------------------------------------
void test_scalu_device( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
        case testsweeper::DataType::SingleComplex:
            test_scalu_device_work< float, std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::Double:
        case testsweeper::DataType::DoubleComplex:
            test_scalu_device_work< double, std::complex<double> >( params, run );
            break;
