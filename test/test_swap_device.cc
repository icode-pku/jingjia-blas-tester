...
void test_swap_device_work( Params& params, bool run )
{
    ...
    if(testcase == 0){
        ...
        blas::swap( -1, dx, incx, dy, incy, queue, testcase, error_name);
        ...
        blas::swap( 0, dx, incx, dy, incy, queue, testcase, error_name);
        Blas_Match_Call( result_match(error_name, "CUBLAS_STATUS_SUCCESS", all_testcase, passed_testcase, failed_testcase), error_name);
        //Test case 3: Test the return when incx is 0
        blas::swap( n, dx, 0, dy, incy, queue, testcase, error_name);
        Blas_Match_Call( result_match(error_name, "CUBLAS_STATUS_SUCCESS", all_testcase, passed_testcase, failed_testcase), error_name);
        //Test case 4: Test the return when incx is -1
        blas::swap( n, dx, -1, dy, incy, queue, testcase, error_name);
        Blas_Match_Call( result_match(error_name, "CUBLAS_STATUS_SUCCESS", all_testcase, passed_testcase, failed_testcase), error_name);
        //Test case 5: Test the return when incy is 0
        blas::swap( n, dx, incx, dy, 0, queue, testcase, error_name);
        Blas_Match_Call( result_match(error_name, "CUBLAS_STATUS_SUCCESS", all_testcase, passed_testcase, failed_testcase), error_name);  
        //Test case 6: Test the return when incy is -1
        blas::swap( n, dx, incx, dy, -1, queue, testcase, error_name);
        Blas_Match_Call( result_match(error_name, "CUBLAS_STATUS_SUCCESS", all_testcase, passed_testcase, failed_testcase), error_name); 
