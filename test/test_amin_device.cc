...
// -----------------------------------------------------------------------------
template <typename T>
void test_amin_device_work( Params& params, bool run )
{
    ...
    // test error exits
    assert_throw( blas::amin( -1, dx, incx, &result, queue), blas::Error );
    assert_throw( blas::amin(  n, dx,    0, &result, queue ), blas::Error );
    ...
    blas::amin( n, dx, incx, &result, queue);
    queue.sync();
    // blas::device_copy_vector(1, &result, 1, &result, 1, queue);
    // queue.sync();
    //same as amax
...
// -----------------------------------------------------------------------------
void test_amin_device( Params& params, bool run )
{
    switch (params.datatype()) {
        case testsweeper::DataType::Single:
            test_amin_device_work< float >( params, run );
            break;

        case testsweeper::DataType::Double:
            test_amin_device_work< double >( params, run );
            break;

        case testsweeper::DataType::SingleComplex:
            test_amin_device_work< std::complex<float> >( params, run );
            break;

        case testsweeper::DataType::DoubleComplex:
            test_amin_device_work< std::complex<double> >( params, run );
            break;
