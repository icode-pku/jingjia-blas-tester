    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasIsamin(
                queue.handle(), 
                n, dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasIdamin(
                queue.handle(), 
                n, dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasIcamin(
                queue.handle(), 
                n, (const cuComplex*)dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasIzamin(
                queue.handle(), 
                n, (const cuDoubleComplex*)dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSasum(
                queue.handle(), 
                n, dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDasum(
                queue.handle(), 
                n, dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasScasum(
                queue.handle(), 
                n, (const cuComplex*)dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDzasum(
                queue.handle(), 
                n, (const cuDoubleComplex*)dx, incdx, 
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSaxpy(
                queue.handle(),
                n, &alpha,
                dx, incdx,
                dy, incdy));
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDaxpy(
                queue.handle(),
                n, &alpha,
                dx, incdx,
                dy, incdy));
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCaxpy(
                queue.handle(),
                n, (const cuComplex*) &alpha,
                (const cuComplex*) dx, incdx,
                (cuComplex*) dy, incdy));
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZaxpy(
                queue.handle(),
                n, (const cuDoubleComplex*) &alpha,
                (const cuDoubleComplex*) dx, incdx,
                (cuDoubleComplex*) dy, incdy));
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSdot(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDdot(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCdotc(
                queue.handle(),
                n,
                (const cuComplex*) dx, incdx,
                (const cuComplex*) dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZdotc(
                queue.handle(),
                n,
                (const cuDoubleComplex*) dx, incdx,
                (const cuDoubleComplex*) dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCdotu(
                queue.handle(),
                n,
                (const cuComplex*) dx, incdx,
                (const cuComplex*) dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZdotu(
                queue.handle(),
                n,
                (const cuDoubleComplex*) dx, incdx,
                (const cuDoubleComplex*) dy, incdy,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSnrm2(
                queue.handle(),
                n, dx, incdx,
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDnrm2(
                queue.handle(),
                n, dx, incdx,
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasScnrm2(
                queue.handle(),
                n, (const cuComplex*) dx, incdx,
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDznrm2(
                queue.handle(),
                n, (const cuDoubleComplex*) dx, incdx,
                result));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSscal(
                queue.handle(),
                n, &alpha,
                dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDscal(
                queue.handle(),
                n, &alpha,
                dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCscal(
                queue.handle(),
                n, (const cuComplex*) &alpha,
                (cuComplex*) dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZscal(
                queue.handle(),
                n, (const cuDoubleComplex*) &alpha,
                (cuDoubleComplex*) dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCsscal(
                queue.handle(),
                n,  &alpha,
                (cuComplex*) dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZdscal(
                queue.handle(),
                n, &alpha,
                (cuDoubleComplex*) dx, incdx));
        int len = strlen(s);
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSswap(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDswap(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCswap(
                queue.handle(),
                n,
                (cuComplex*) dx, incdx,
                (cuComplex*) dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZswap(
                queue.handle(),
                n,
                (cuDoubleComplex*) dx, incdx,
                (cuDoubleComplex*) dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasScopy(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDcopy(
                queue.handle(),
                n,
                dx, incdx,
                dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCcopy(
                queue.handle(),
                n,
                (cuComplex*) dx, incdx,
                (cuComplex*) dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZcopy(
                queue.handle(),
                n,
                (cuDoubleComplex*) dx, incdx,
                (cuDoubleComplex*) dy, incdy) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    ...
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasHgemm(
                queue.handle(),
                op2cublas(transA, testcase), op2cublas(transB, testcase),
                m, n, k,
                (__half*)&alpha1, 
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasStrsm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
            &alpha,
            dA, ldda,
            dB, lddb ) );
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDtrsm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCtrsm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZtrsm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasStrmm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDtrmm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCtrmm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZtrmm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            op2cublas(trans, testcase), diag2cublas(diag, testcase),
            m, n,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSsymm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            m, n,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDsymm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            m, n,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCsymm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            m, n,
            (cuComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname  )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZsymm(
            queue.handle(),
            side2cublas(side, testcase), uplo2cublas(uplo, testcase),
            m, n,
            (cuDoubleComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSsyrk(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDsyrk(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCsyrk(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            (cuComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZsyrk(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            (cuDoubleComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasSsyr2k(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasDsyr2k(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            &alpha, dA, ldda,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasCsyr2k(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            (cuComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    if(testcase == 1){
        ...
        const char* s = device_errorstatus_to_string(cublasZsyr2k(
            queue.handle(),
            uplo2cublas(uplo, testcase), op2cublas(trans, testcase),
            n, k,
            (cuDoubleComplex*) &alpha,
    ...
    blas::Queue& queue, device_blas_int testcase, char *errname )
{
    ...
    blas_dev_call(
        cublasHgemmBatched(
            ...
            m, n, k,
            &alpha_,
            (__half const**) dAarray, ldda,
            (__half const**) dBarray, lddb,
            &beta_,
            (__half**) dCarray, lddc,
            batch_size ) );
    }
    else{
        const char* s = device_errorstatus_to_string(cublasHgemmBatched(
            queue.handle(),
            op2cublas(transA, testcase), op2cublas(transB, testcase),
            m, n, k,
            &alpha_,
